...
function App() {
  ...
  const defaultAvatar = "https://doughmination.win/common/fallback_avatar.png";
    ...
    <div className="flex flex-col min-h-screen max-w-6xl mx-auto text-black dark:text-white">
      ...
      <footer className="github-footer">
        <div className="flex flex-col items-center gap-2">
          <a href="https://git.clovetwilight3.co.uk/clovetwilight3/plural-web" target="_blank" rel="noopener noreferrer" className="github-button">
